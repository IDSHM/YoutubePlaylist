...
const SongRow = () => {
    ...
    return (
        <>
            <table style={{marginLeft:"100px",marginTop:"-502px", marginRight:"800px"}}>
                <tbody>
                    <tr>
                        <th>Image</th>
                        <th>Song Name</th>
                    ...
                    {songList.map((item, index) => {
                        return (
                            <tr key={index}>
                                ...
                                <td>
                                    <button style={{ padding:"10px", backgroundColor: 'green', color: 'white',fontSize: "20px", fontFamily:"cursive"}} onClick={()=>handlePlaySong(item.id)}>Play</button>
                                    <button style={{ padding:"10px", backgroundColor: 'red', color: 'white',fontSize: "20px", fontFamily:"cursive"}} onClick={()=>handlePauseSong(item.id)}>Pause</button>
                                </td>
